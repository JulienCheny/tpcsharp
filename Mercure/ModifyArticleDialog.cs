...
namespace Mercure
{
    public partial class ModifyArticleDialog : Form
    {
        ...
        public ModifyArticleDialog(SQLiteConnection sqliteParam, string refArticle)
        {
            sqlite = sqliteParam;
        ...
        public ModifyArticleDialog(SQLiteConnection sqliteParam)
        {
            sqlite = sqliteParam;
            setupWindow();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "UPDATE Articles SET RefArticle =  @RefArticle, Description = @Description, RefSousFamille = @RefSousFamille, RefMarque = @RefMarque, PrixHT = @PrixHT, Quantite = @Quantite WHERE RefArticle = @LastRefArticle";
